      ...
      <div class="row gy-4 d-flex justify-content-center">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            ...
            <div class="card-body">
              <h3><a href="#form" class="stretched-link" data-i18n="aboutview.teamone">Alexandr Serebryakov</a></h3>
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            ...
            <div class="card-body">
              <h3><a href="#form" class="stretched-link" data-i18n="aboutview.teamtwo">Artur Khabibrakhmanov</a></h3>
              <div class="card-content">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            ...
            <div class="card-body">
              <h3><a href="#form" class="stretched-link" data-i18n="aboutview.teamthree">Aram Keryan</a></h3>
              <div class="card-content">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
          <div class="card">
            ...
            <div class="card-body">
              <h3><a href="#multi_pong" class="stretched-link" data-i18n="aboutview.teamfour">Nauman Munir</a></h3>
              <div class="card-content">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
          <div class="card">
            ...
            <div class="card-body">
              <h3><a href="#form" id="eight_players" class="stretched-link" data-i18n="aboutview.teamfive">Alaa Bashir</a></h3>
              <div class="card-content">
