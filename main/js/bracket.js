import { playerList } from './register.js';
...
async function simulateTournament(matches) {
    ...
    for (let i = 0; i < matches.length; i++) {
        ...
        winners.push(winner);  // Add the winner to the list of winners
        console.log(`Match ${i + 1}: ${match[0]} vs ${match[1]} - Winner: ${winner}`);
    }
...
function displayWinner(winner) {
    ...
    winnerDiv.id = 'winnerDisplay'; // Assign the winner display style
